...
export CTS_LOG_DIR="/DATA/home/edu135/MNIST/$trial_log_root/05_cts_no_ccd"
export CTS_REPORT_DIR="/DATA/home/edu135/MNIST/$trial_report_root/05_cts_no_ccd"
export ROUTE_LOG_DIR="/DATA/home/edu135/MNIST/$trial_log_root/06_route_from_cts_no_ccd"
export ROUTE_REPORT_DIR="/DATA/home/edu135/MNIST/$trial_report_root/06_route_from_cts_no_ccd"

mkdir -p "$CTS_LOG_DIR" "$CTS_REPORT_DIR" "$ROUTE_LOG_DIR" "$ROUTE_REPORT_DIR"

icc2_shell -f 4_Backend_ICC2/0_Script/05_cts/run_cts_no_ccd_low_power.tcl \
  | tee "$CTS_LOG_DIR/run.log"

icc2_shell -f 4_Backend_ICC2/0_Script/06_route/run_route_initial.tcl \
  | tee "$ROUTE_LOG_DIR/run.log"

echo "MNIST_TRIM_ALL_PIN_CTS_NO_CCD_ROUTE_DONE report_root=$trial_report_root"
