...
debug_subdir="${ROUTE_DEBUG_SUBDIR:-06_route_debug}"
report_dir="4_Backend_ICC2/4_Report/trials/$trial_name/$debug_subdir"
log_dir="4_Backend_ICC2/3_Log/trials/$trial_name/$debug_subdir"
...
: "${ROUTE_DEBUG_INPUT_BLOCK:=route}"
export ROUTE_DEBUG_INPUT_BLOCK
