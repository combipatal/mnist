...
ndm_dir="4_Backend_ICC2/2_Output/00_setup/ndm_libdir_via1_no_track"
log_dir="4_Backend_ICC2/3_Log/00_setup"
src_tf="/DATA/home/edu135/lib/SAED32_EDK/tech/milkyway/saed32nm_1p9m_mw.tf"
dst_tf="$tech_dir/saed32nm_1p9m_mw.via1_pitch_no_track.tf"
...
env \
  ...
  lm_shell -f 4_Backend_ICC2/0_Script/00_setup/build_saed32_rvt_ndm_libdir_via1_no_track.tcl \
    | tee "$log_dir/build_saed32_rvt_ndm_libdir_via1_no_track.log"

echo "MNIST_LIBDIR_VIA1_NO_TRACK_NDM_DONE ndm_dir=$ndm_dir tech_file=$dst_tf"
